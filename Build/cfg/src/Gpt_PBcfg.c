...
*/
extern void Ftm0_ch0_callback(void);
extern void Ftm0_ch1_callback(void);
...
{
    0, /* Logical Channel Gpt_Ftm0_ch0*/
    1  /* Logical Channel Gpt_Ftm0_ch1*/
};
...
{
    {   /*Gpt_Ftm0_ch0 configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Ftm0_ch0_callback, /* Channel notification */
...
,
    {   /*Gpt_Ftm0_ch1 configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Ftm0_ch1_callback, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
#endif
        (Gpt_ValueType)(65535U), /* Maximum ticks value*/
